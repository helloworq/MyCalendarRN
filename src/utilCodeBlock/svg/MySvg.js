        ...
        <>
            ...
            <View style={{ flex: 1 }}>
                ...
                >
                    ...
                    {/* <MySvgMap id='安源区' path={anyuan} select={select} setSelect={(e) => setSelect(e)} />
                    <MySvgMap id='湘东区' path={xiangdong} select={select} setSelect={(e) => setSelect(e)} />
                    <MySvgMap id='上栗县' path={shangli} select={select} setSelect={(e) => setSelect(e)} />
                    <MySvgMap id='芦溪县' path={luxi} select={select} setSelect={(e) => setSelect(e)} />
                    <MySvgMap id='莲花县' path={lianhua} select={select} setSelect={(e) => setSelect(e)} /> */}
